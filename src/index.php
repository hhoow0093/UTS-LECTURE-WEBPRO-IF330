...
<body class="bg-secondary-subtle">
    ...
    <!--Carousel-->
    <section class="container bg-secondary-subtle mx-auto my-5" style="min-height: 50vh; padding:0;">
        <div id="carouselExampleDark" class="carousel carousel-dark slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="../Assets/Carousel Img/img1.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block" style="background-color: rgb(0, 0, 0, 0.7);">
                        <h5 class="text-white">Explore Our Campus!</h5>
                        <p class="text-white">Our campus is very fun!</p>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="../Assets/Carousel Img/img2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block" style="background-color: rgb(0, 0, 0, 0.7);">
                        <h5 class="text-white">Explore Our Lab!</h5>
                        <p class="text-white">Our campus have very interesting lab</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="../Assets/Carousel Img/img4.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block" style="background-color: rgb(0, 0, 0, 0.7);">
                        <h5 class="text-white">Explore Our Building</h5>
                        <p class="text-white">Our building is also very interesting, check it out!</p>
                    </div>
                </div>
            </div>
    ...
    <section class="mt-5" id="contact-section">
        <footer class="row row-cols-1 p-5 border-top text-white" style="background-color: #336699;">
            <div class="col-12 col-md-4 mb-3 ms-3">
            ...
            <div class="col-12 col-md-4 mb-3 ms-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2">
                        <a href="https://www.youtube.com/@UniversitasMultimediaNusantara" class="nav-link p-0 text-white">
                    ...
                    <li class="nav-item mb-2"><a href="https://www.instagram.com/universitasmultimedianusantara/" class="nav-link p-0 text-white">
                    ...
                    <li class="nav-item mb-2"><a href="https://api.whatsapp.com/send?phone=6281289015005&text=Halo" class="nav-link p-0 text-white">
